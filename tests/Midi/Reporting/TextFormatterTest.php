<?php
	...
	class TextFormatterTest extends \PHPUnit_Framework_TestCase {
		...
		public function setUp() {
			$this->obj = new \Midi\Reporting\TextFormatter();
		}
		...
		public function testBeforeFileHeader() {
			$fileHeader = $this->getMock('Midi\FileHeader', array('getData'), array(), '', false);
		...
		public function testAfterFileHeader() {
			$this->obj = $this->getMock('Midi\Reporting\TextFormatter', array('decreaseIndent'));
		...
		public function testFormatTrackHeaderAndAfterTrack() {
			$trackHeader = $this->getMock('Midi\TrackHeader', array('getData'), array(), '', false);
		...
		public function testFormatEvent() {
			$event = $this->getMock('Midi\Event', array('getData', '__toString', 'toBinary', 'getLength', 'getType'), array(), '', false);
