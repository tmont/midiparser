...
HTML;
		...
		public function testAfterFile() {
			...
			<div id="footer">
				<p>
					Generated by <a title="PHP MIDI Library $version" href="http://phpmidiparser.com/">PHP MIDI Library $version</a> in 10 seconds on $date \d\d?:\d\d:\d\d [AP]M
					<br />
					by <a title="by Tommy Montgomery" href="http://tommymontgomery.com/">Tommy Montgomery</a>
				</p>
			</div>
		</div>
	</body>
...
HTML;
		...
		public function testAfterFileWithMultiFile() {
			...
			<div id="footer">
				<p>
					Generated by <a title="PHP MIDI Library $version" href="http://phpmidiparser.com/">PHP MIDI Library $version</a> on $date \d\d?:\d\d:\d\d [AP]M
					<br />
					by <a title="by Tommy Montgomery" href="http://tommymontgomery.com/">Tommy Montgomery</a>
				</p>
			</div>
